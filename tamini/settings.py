"""
Django settings for tamini project.
...
SECRET_KEY = 'django-insecure-*+e#uz0yid@(=8@c4r7_kh()5yktou(&h0$@ro9&+mru4o0$+4'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'ahadethnabawea@gmail.com'
EMAIL_HOST_PASSWORD = 'oalozjmlhtnbytuc'
